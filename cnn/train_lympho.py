...
from preprocess3d import TRAIN_AUGS_3D, TEST_AUGS_3D

parser = argparse.ArgumentParser("LymphoCyte")
parser.add_argument('--data', type=str, default='/data2/DW/181121_Lympho/lympho_dataset/190110_mice/190206_mice_add_3split_', help='location of the data corpus')
parser.add_argument('--batch_size', type=int, default=128, help='batch size')
parser.add_argument('--learning_rate', type=float, default=0.1, help='init learning rate')
parser.add_argument('--momentum', type=float, default=0.9, help='momentum')
parser.add_argument('--weight_decay', type=float, default=3e-5, help='weight decay')
parser.add_argument('--report_freq', type=float, default=100, help='report frequency')
parser.add_argument('--gpus', type=str, default="0,1,2,3", help='gpu device id')
